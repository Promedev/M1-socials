...
/**
 * Class MP_Socials_Helper_Twitter
 *
 * @category   MP
 * @package    MP_Socials
 * @author     Merchant Protocol Team <info@merchantprotocol.com>
 */
class MP_Socials_Helper_Twitter extends MP_Socials_Helper_Data
{
    /**
     * @const string
     */
    const AUTH_PROVIDER = 'twitter';

    /**
     * @const string
     */
    const ACCOUNT_CSRF        = 'google_csrf';
    const ACCOUNT_ID_FIELD    = 'social_twitter_id';
    const ACCOUNT_TOKEN_FIELD = 'social_twitter_token';
