...
/**
 * Class MP_Socials_Helper_Linkedin
 *
 * @category   MP
 * @package    MP_Socials
 * @author     Merchant Protocol Team <info@merchantprotocol.com>
 */
class MP_Socials_Helper_Linkedin extends MP_Socials_Helper_Data
{
    /**
     * @const string
     */
    const AUTH_PROVIDER = 'linkedin';

    /**
     * @const string
     */
    const ACCOUNT_CSRF        = 'google_csrf';
    const ACCOUNT_ID_FIELD    = 'social_linkedin_id';
    const ACCOUNT_TOKEN_FIELD = 'social_linkedin_token';
